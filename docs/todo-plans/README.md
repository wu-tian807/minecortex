...
| 阶段 | Plans | 并行度 | 说明 |
|------|-------|--------|------|
| Phase 0 | P0 | 1 | 前置：定义所有共享接口契约（附属：P0-directory-design） |
| Phase 1 | P1, P2, P3, P4, P5, P6, P12 | 7 | 核心：全部可并行，互不依赖 |
| Phase 2 | P7, P8 | 2 | Slot+订阅：等待 P3(+P4)完成 |
| Phase 3 | P9, P10, P11 | 3 | 高阶：P9/P10 等 P1+P7，P11 等 P4+P7+P8+P9 |
...
| 0+ | P0 附属 | src/ 模块化目录设计 | [P0-directory-design.plan.md](P0-directory-design.plan.md) | P0 |
| 1 | P1 | LLM 层重构 (流式+Response API) | [P1-llm-layer.plan.md](P1-llm-layer.plan.md) | P0 |
| 2 | P2 | 文件工具 + PathManager + Terminal + list_dir + shell | [P2-file-tools.plan.md](P2-file-tools.plan.md) | P0 |
...
| 9 | P9 | Session 管理 + 用户命令系统 | [P9-session.plan.md](P9-session.plan.md) | P1, P7 |
| 10 | P10 | Agent 子任务 + 生命周期 | [P10-agent-lifecycle.plan.md](P10-agent-lifecycle.plan.md) | P1, P7 |
| 11 | P11 | 核心交互工具 + 默认指令 | [P11-core-interaction-tools.plan.md](P11-core-interaction-tools.plan.md) | P0, P4, P7, P8, P9 |
| 12 | P12 | Web/Browser 工具 | [P12-web-tools.plan.md](P12-web-tools.plan.md) | P0 |
...
| `ToolDefinition.input_schema` | P2,P7,P8,P9,P10,P11,P12 | JSON Schema 直连，零转换 |
| `ToolContext` 接口 | P2,P4,P7,P8,P10,P11,P12 | P0 定义形状，各 Plan 实现对应功能 |
| `CapabilitySelector` | P0,P2,P7,P8,P11 | `default` 重命名为 `global`，脑内部始终 enabled |
...
| `scheduler.ts` | P3,P4,P6,P10,P11 | P3(FSWatcher) P4(Board) P6(分支) P10(shutdown) P11(create_brain) |

## 扩展模块（核心完成后按需）

- Browser 工具完整实现 — P12 后期扩展
